...
function quiz2()
{
	...
	var qst3 = document.getElementsByName("qst3");
	var qst4 = document.getElementsByName("qst4");
	if ( (!qst1[0].checked && !qst1[1].checked && !qst1[2].checked) || (!qst2[0].checked && !qst2[1].checked && !qst2[2].checked) || (!qst3[0].checked && !qst3[1].checked && !qst3[2].checked) || (!qst4[0].checked && !qst4[1].checked && !qst4[2].checked)  )
	 {
	 	document.getElementById("dang").innerHTML = "Veuillez répondre à toutes les questions.";
	 	document.getElementById("dang").style.display = "block";
	 }
	 else
	 {
	 	...
	 	{
	 		if(qst2[2].checked) document.getElementById("s22").style.color = "red";
	 		else document.getElementById("s21").style.color = "red";
	 	}
	 	if (qst3[1].checked) {
	 		i++;
	 	...
	 	document.getElementById("s11").style.color = "#30DC36";
	 	document.getElementById("s11").style.fontWeight = "bold";
	 	document.getElementById("s20").style.color = "#30DC36";
	 	document.getElementById("s20").style.fontWeight = "bold";
	 	document.getElementById("s31").style.color = "#30DC36";
	 	document.getElementById("s31").style.fontWeight = "bold";
	 	document.getElementById("s41").style.color = "#30DC36";
	 	document.getElementById("s41").style.fontWeight = "bold";
